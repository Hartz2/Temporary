...
real_signal = awgn(ideal_signal, excellent_SNR);
...
figure(1), 
subplot(4,1,1)
plot(t, ideal_signal, 'k', 'LineWidth', 2)
xlabel('Time (s)')
ylabel('Amplitude')
...
subplot(4,1,2)
plot(t, real_signal, 'r', 'LineWidth', 1.5)
xlabel('Time (s)')
ylabel('Amplitude')
...
subplot(4,1,3)
plot(t, scaled_filtered_signal, 'b', 'LineWidth', 1.5)
xlabel('Time (s)')
ylabel('Amplitude')
...
subplot(4,1,4)
plot(t_interpolation, interpolated_signal, 'g', 'LineWidth', 1.5)
xlabel('Time (s)')
ylabel('Amplitude')
